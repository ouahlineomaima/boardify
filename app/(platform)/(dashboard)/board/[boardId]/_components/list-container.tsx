...
export const ListContainer = ({ data, boardId }: ListContainerProps) => {
  ...
  const onDragEnd = (result: any) => {
    ...
    // Case: Droped in the same position
    if (
    ...
    if (type === "card") {
      ...
      //case: moving card in the same list
      if (source.droppableId === destination.droppableId) {
        ...
        //case: moving card to a diffrent list
      }
      else {
        ...
        // update cards order in dest list
